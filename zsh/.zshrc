...
zrcautoload zmv
zrcautoload zed
# Creating aliases for  my personal use
# myalias
alias v=vim
alias serv=http-server
cowsays(){fortune|cowsay}

setup(){mkdir $1 && cd $1 && touch $2}
...
if which rbenv > /dev/null; then eval "$(rbenv init -)"; fi
  ...
  # added by travis gem
  [ -f /Users/BrandonT932/.travis/travis.sh ] && source /Users/BrandonT932/.travis/travis.sh
